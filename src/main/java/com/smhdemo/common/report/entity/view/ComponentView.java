...
@SequenceGenerator(name = "seq_report_componentview", sequenceName = "seq_report_componentview_id", allocationSize = 1)
public class ComponentView implements Serializable {

    private static final long serialVersionUID = 6470965538592594049L;
    
	@Id
    @GeneratedValue(generator = "seq_report_componentview",strategy = GenerationType.SEQUENCE)
	@Column(name = "id")
