 ...
 * http://www.ewcms.com
 */
package com.smhdemo.common.datasource.generate.factory.init;
...
import com.smhdemo.common.datasource.entity.Jdbc;
import com.smhdemo.common.datasource.entity.Jndi;
import com.smhdemo.common.datasource.generate.factory.init.bean.BeanForInterfaceFactoryable;
 ...
 */
@Service
public class InitDataSourceFactory implements InitDataSourceFactoryable, InitializingBean {

	private static final Logger logger = LoggerFactory.getLogger(InitDataSourceFactory.class);
    ...
    static {
        ...
        serviceDefinitionMap.put(Jdbc.class.getName().toString(), "jdbcDataSourceFactory");
        serviceDefinitionMap.put(Jndi.class.getName().toString(), "jndiDataSourceFactory");
        serviceDefinitionMap.put(Bean.class.getName().toString(), "beanDataSourceFactory");
        serviceDefinitionMap.put(Custom.class.getName().toString(), "customDataSourceFactory");
    }
