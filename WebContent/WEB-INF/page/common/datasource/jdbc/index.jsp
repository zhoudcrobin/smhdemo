...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<c:url value="/common/datasource/jdbc/query.do"/>');
			...
			ewcmsOOBJ.setInputURL('<c:url value="/common/datasource/jdbc/edit.do"/>');
			ewcmsOOBJ.setDeleteURL('<c:url value="/common/datasource/jdbc/delete.do"/>');
		});
		function test(id){
	...
	<body class="easyui-layout">
        ...
        <div id="edit-window" class="easyui-window" closed="true" icon="icon-winedit" title="编辑-jdbc数据源 " style="display:none;">
        ...
        <div id="query-window" class="easyui-window" closed="true" icon='icon-search' title="查询-jdbc数据源"  style="display:none;">
            <div class="easyui-layout" fit="true"  >
                <div region="center" border="false" >
                <f:form id="queryform">
