...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<c:url value="/common/datasource/jndi/query.do"/>');
			...
			ewcmsOOBJ.setInputURL('<c:url value="/common/datasource/jndi/edit.do"/>');
			ewcmsOOBJ.setDeleteURL('<c:url value="/common/datasource/jndi/delete.do"/>');
		});
		function test(id){
