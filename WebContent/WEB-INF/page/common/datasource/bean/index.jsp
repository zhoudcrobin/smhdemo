...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<c:url value="/common/datasource/bean/query.do"/>');
			...
			ewcmsOOBJ.setInputURL('<c:url value="/common/datasource/bean/edit.do"/>');
			ewcmsOOBJ.setDeleteURL('<c:url value="/common/datasource/bean/delete.do"/>');
		});
	...
	<body class="easyui-layout">
        ...
        <div id="edit-window" class="easyui-window" closed="true" icon="icon-winedit" title="编辑-bean数据源 " style="display:none;">
        ...
        <div id="query-window" class="easyui-window" closed="true" icon='icon-search' title="查询-bean数据源"  style="display:none;">
            <div class="easyui-layout" fit="true"  >
                <div region="center" border="false" >
                <f:form id="queryform">
